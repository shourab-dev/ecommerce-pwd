    ...
    <div class="axil-main-slider-area main-slider-style-1">
        <div class="container">
            <div class="row align-items-center">
                                ...
                                <div class="single-slide slick-slide" data-sal="slide-up" data-sal-delay="600" data-sal-duration="1500">
                                    <img src="{{ asset(' frontend/assets/images/product/product-38.png') }}"
                                        ...
                                        <div class="single-slide slick-slide" data-sal="slide-up" data-sal-delay="600"
                                            ...
                                            <img src="{{ asset('frontend/assets/images/product/product-39.png') }}"
                                                alt="Product">
                                            <div class="product-price">
                                                <span class="text">From</span>
                                                <span class="price-amount">$49.00</span>
                ...
                <li class="shape-2"><img src="{{ asset(' frontend/assets/images/others/shape-2.png"') }} alt="Shape">
                        </li>
                    </ul>
                </div>
                                ...
                                <div class="row row--15">
                                            ...
                                            <div class="thumbnail">
                                                ...
                                                <div class="product-hover-action">
                                                    <ul class="cart-action">
                                                        <li class="quickview"><a href="index-1.html#"
                                            ...
                                            <div class="thumbnail">
                                                <a href="single-product.html">
                                                    <img data-sal="zoom-out" data-sal-delay="300"
                                                        data-sal-duration="800" loading="lazy"
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                        <div class="axil-product product-style-one">
                                            <div class="thumbnail">
                                                <a href="single-product.html">
                                                    <img data-sal="zoom-out" data-sal-delay="400"
                                                        data-sal-duration="800" loading="lazy"
                                            ...
                                            <div class="product-content">
                                                <div class="inner">
                                                    <h5 class="title"><a href="single-product.html">Logitech
                                                            Streamcam</a></h5>
                                                    <div class="product-price-variant">
                                                        <span class="price current-price">$29.99</span>
                                                        <span class="price old-price">$49.99</span>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                        <div class="axil-product product-style-one">
                                            <div class="thumbnail">
                                                <a href="single-product.html">
                                                    <img data-sal="zoom-out" data-sal-delay="500"
                                                        data-sal-duration="800" loading="lazy"
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                        <div class="axil-product product-style-one">
                                            ...
                                            <div class="product-content">
                                                <div class="inner">
                                                    <h5 class="title"><a href="single-product.html">Bass Meets
                                                            Clarity</a></h5>
                                                    <div class="product-price-variant">
                                                        <span class="price current-price">$29.99</span>
                                                        <span class="price old-price">$49.99</span>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                        <div class="axil-product product-style-one">
                                            ...
                                            <div class="product-content">
                                                <div class="inner">
                                                    <h5 class="title"><a href="single-product.html">Mice Logitech</a>
                                                    </h5>
                                                    <div class="product-price-variant">
                                                        <span class="price current-price">$29.99</span>
                                                        <span class="price old-price">$49.99</span>
                                        ...
                                        <div class="axil-product product-style-one">
                                            ...
                                            <div class="product-content">
                                                <div class="inner">
                                                    ...
                                                    <h5 class="title"><a href="single-product.html">Zone Headphone</a>
                                                    </h5>
                                                    <div class="product-price-variant">
                                                        <span class="price current-price">$29.99</span>
                                                        <span class="price old-price">$49.99</span>
                                    ...
                                    <div class="axil-product product-style-two">
                                        ...
                                        <div class="product-content">
                                            <div class="inner">
                                                ...
                                                <h5 class="title"><a href="single-product.html">PS5 Smart Remote</a>
                                                </h5>
                                                <div class="product-price-variant">
                                                    <span class="price old-price">$50</span>
                                ...
                                <div class="col">
                                    <div class="axil-product-list">
                                        ...
                                        <div class="product-content">
                                            ...
                                            <h6 class="product-title"><a href="single-product.html">Media Remote</a>
                                            </h6>
                                            <div class="product-price-variant">
                                                <span class="price current-price">$29.99</span>
                                                <span class="price old-price">$49.99</span>
                                            ...
                                            <div class="product-cart">
                                                ...
                                                <a href="wishlist.html" class="cart-btn"><i
                                ...
                                <div class="col">
                                    <div class="axil-product-list">
                                        ...
                                        <div class="product-content">
                                            ...
                                            <h6 class="product-title"><a href="single-product.html">Gaming
                                                    Controller</a></h6>
                                            <div class="product-price-variant">
                                ...
                                <div class="col">
                                    <div class="axil-product-list">
                                        ...
                                        <div class="product-content">
                                            ...
                                            <h6 class="product-title"><a href="single-product.html">Lenevo Laptop</a>
                                            </h6>
                                            <div class="product-price-variant">
                                ...
                                <div class="col">
                                    <div class="axil-product-list">
                                        ...
                                        <div class="product-content">
                                            ...
                                            <h6 class="product-title"><a href="single-product.html">Wireless
                                                    Headphone</a></h6>
                                            <div class="product-price-variant">
                                ...
                                <div class="col">
                                    <div class="axil-product-list">
                                        ...
                                        <div class="product-content">
                                            ...
                                            <h6 class="product-title"><a href="single-product.html">Asus Zenbook
                                                    Laptop</a></h6>
                                            <div class="product-price-variant">
                        ...
                        <div class="row row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-1 row--20">
                            <div class="col">
                                <div class="service-box">
                                    <div class="icon">
                                        <img src="{{ asset('frontend/assets/images/icons/service6.p') }} ng"
                                            alt="Service">
                                    </div>
                            ...
                            <div class="col">
                                <div class="service-box">
                                    <div class="icon">
                                        <img src="{{ asset('frontend/assets/images/icons/service7.p') }} ng"
                                            alt="Service">
                                    </div>
                            ...
                            <div class="col">
                                <div class="service-box">
                                    <div class="icon">
                                        <img src="{{ asset('frontend/assets/images/icons/service8.p') }} ng"
                                            alt="Service">
                                    </div>
                            ...
                            <div class="col">
                                <div class="service-box">
                                    <div class="icon">
                                        <img src="{{ asset('frontend/assets/images/icons/service9.p') }} ng"
                                            alt="Service">
                                    </div>
                                    <h6 class="title">24 Hour Return Policy</h6>
                                </div>
                            ...
                            <div class="col">
                                <div class="service-box">
                                    <div class="icon">
                                        <img src="{{ asset('frontend/assets/images/icons/service10.p') }} ng"
                                            alt="Service">
                                    </div>
