        ...
        <div class="container">
            <div class="axil-dashboard-warp">
                <div class="axil-dashboard-author">
                    <div class="media">
                        <div class="thumbnail">
                            <img width="80" src="{{ getProfileUrl('web') }}" alt="{{ auth()->user()->name }}">

                        </div>
                        <div class="media-body">
                            <h5 class="title mb-0">Hello {{ auth()->user()->name }}</h5>
                            <span class="joining-date">{{ env('APP_NAME') }} Member Since {{
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="nav-dashboard" role="tabpanel">
                                <div class="axil-dashboard-overview">
                                    <div class="welcome-text">Hello {{ str(auth()->user()->name)->headline() }} (not
                                        <span>{{ str(auth()->user()->name)->headline() }}?</span>
                                        <a href="#" onclick="document.querySelector(`#logoutForm`).submit()">Log Out</a>)
                                    </div>
