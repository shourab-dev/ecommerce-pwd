...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('frontend/assets/im') }} ages/favicon.png">
                                    ...
                                    <div class="col-lg-2 order-lg-1">
                                        <div class="product-small-thumb small-thumb-wrapper">
                                            <div class="small-thumb-img">
                                                ...
                                                <div class="small-thumb-img">
                                                    <img src="{{ asset('
                                                    frontend/assets/images/product/product-thumb/thumb-07.png" ') }} alt="thumb image">
                                                </div>
                                                <div class="small-thumb-img">
                                                    <img src="{{ asset('
                                                    frontend/assets/images/product/product-thumb/thumb-09.png" ') }} alt="thumb image">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <ul class="cart-item-list">
                                        <li class="cart-item">
                                            ...
                                            <div class="item-content">
                                                ...
                                                <h3 class="item-title"><a href="single-product-3.html">Wireless PS
                                                        Handler</a></h3>
                                                <div class="item-price"><span class="currency-symbol">$</span>155.00
                                                </div>
                                        ...
                                        <li class="cart-item">
                                            ...
                                            <div class="item-content">
                                                ...
                                                <h3 class="item-title"><a href="single-product-2.html">Gradient Light
                                                        Keyboard</a></h3>
                                                <div class="item-price"><span class="currency-symbol">$</span>255.00
                                                </div>
                                                <div class="pro-qty item-quantity">
                                        ...
                                        <li class="cart-item">
                                            ...
                                            <div class="item-content">
                                                ...
                                                <h3 class="item-title"><a href="single-product.html">HD CC Camera</a>
                                                </h3>
                                                <div class="item-price"><span class="currency-symbol">$</span>200.00
                                                </div>
                                                <div class="pro-qty item-quantity">
