                            ...
                            <div class="notification-box ml-15 d-none d-md-flex">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="notification">
                                    ...
                                    <li>
                                        <a href="#0">
                                            <div class="image">
                                                <img src="{{ getProfileUrl('admin') }}" alt="" />
                                            </div>
                                            <div class="content">
                                                <h6>
                                                    Jonathon
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profile">
                                    <li>
                                        <div class="author-info flex items-center !p-1">
                                            <div class="image">
                                                <img src="{{ getProfileUrl('admin') }}" alt="image">
                                            </div>
                                            <div class="content" style=" word-wrap:break-word;overflow:hidden;">
                                    ...
                                    <li class="divider"></li>
                                    <li>
                                        <a onclick="document.querySelector(`#logoutForm`).submit()" href="#"> <i class="lni lni-exit"></i> Sign Out </a>
